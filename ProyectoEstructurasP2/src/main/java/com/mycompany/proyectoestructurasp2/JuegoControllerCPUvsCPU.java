...
public class JuegoControllerCPUvsCPU<T>{

    private static char figuraJugador1 = 'X';
    private static char figuraJugador2 = 'O';
    ...
    private void initialize() {
        ...
        System.out.println("OYE: LA figura del jugador 1 es: " + figuraJugador1);
        System.out.println("OYE: LA figura del jugador 2 es: " + figuraJugador2);
        
        tableroJuego.mostrarTablero();
        TreeComparator<Tablero> cmp = Tablero::compareTo;
        
//        oponenteJuega(tablero,tableroJuego,espacios_ocupados, fichaJ2, fichaJ1, cmp,empiezaJugador);
//        if(!empiezaJugador) {
